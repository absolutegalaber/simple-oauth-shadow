...
public class ShadowTokenFilter implements Filter {
    ...
    public static final String REQ_ACCOUNT_ID_KEY = "org.absolutegalaber.simpleoauth.shadow.filter.ShadowTokenFilter_account_id";
    public static final String REQ_CLIENT_ID_KEY = "org.absolutegalaber.simpleoauth.shadow.filter.ShadowTokenFilter_client_id";
    public static final String REQ_SCOPES_KEY = "org.absolutegalaber.simpleoauth.shadow.filter.ShadowTokenFilter_scopes";
