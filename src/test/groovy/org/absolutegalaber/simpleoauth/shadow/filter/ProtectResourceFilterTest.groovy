...
class ProtectResourceFilterTest extends Specification {
    ...
    def "DoFilterWithNoAccount"() {
        ...
        then:
        1* mockReq.getAttribute("org.absolutegalaber.simpleoauth.shadow.filter.ShadowTokenFilter_account_id") >> null
    ...
    def "DoFilterWithAccount"() {
        ...
        then:
        1* mockReq.getAttribute("org.absolutegalaber.simpleoauth.shadow.filter.ShadowTokenFilter_account_id") >> "123"
